...
public class AgendaMedicos extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/view/ViewAgendaM.fxml"));
        stage.initStyle(StageStyle.UNDECORATED);
        stage.setScene(new Scene(root));
        stage.setTitle("Agendamentos Medico");
        stage.show();
        setStage(stage);
